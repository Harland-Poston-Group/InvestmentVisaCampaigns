...
<section id="top-banner">
    <img src="/assets/img/campaigns/simon/Geral.webp" alt="Residency and Citizenship" class="header-image">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                <div class="card-residency portugal h-100">
                    <h1 class="card-title">
                        <span class="one">PORTUGAL</span><br><span class="two">Golden Visa</span>
                    </h1>
                    <div class="info row">
                        <div class="info-text col-12 col-sm-8 ps-0">
                            From <b>€500K</b> via<br> investment funds
                        </div>
