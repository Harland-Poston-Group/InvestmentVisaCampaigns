    ...
    <body>
        ...
        <div class="container form-container-element banner-form-container">
            ...
            <form id="" class="generic-form-container">
                ...
                <span class="consent-text">{{ translate('By submitting this form, you confirm that you agree that your data will be used to contact you.', $lang) }}' <a href="https://www.investmentvisa.com/privacy-policy" target="_blank"><u>{{ translate('Read More', $lang) }}</u></a></span>
