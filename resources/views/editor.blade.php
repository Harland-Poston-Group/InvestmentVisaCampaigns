...
@section('content')
    <div class="container">
        <div id="gjs" style="height: 500px; border: 1px solid #ccc;">
            <!-- Your HTML content here, it will be editable via GrapeJS -->
        </div>
    </div>
@endsection
    ...
    <script>
        ...
        const editor = grapesjs.init({
            ...
            storageManager: {
                type: 'remote',
                stepsBeforeSave: 1,
                urlStore: '{{ route("editor.store") }}', // URL to store HTML content
                urlLoad: '{{ route("editor.load") }}' // URL to load HTML content
            },
        });
    </script>
@endpush
