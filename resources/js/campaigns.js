...
$(document).ready(function(){
    ...
    let geoDataPromise = fetchGeoData();
    ...
    function fetchGeoData() {
        return fetchPrimaryGeoData().catch(() => fetchFallbackGeoData());
    }

    // Function to fetch geolocation data from primary API
    function fetchPrimaryGeoData() {
        return fetch('https://api.ipgeolocation.io/ipgeo?apiKey=55e4b1ac2c0b4e05ad22deb513fe9bcd')
            .then(response => {
